...
new Swiper('.welcome__slider', {
	wrapperClass: "welcome__slider-body",
	...
	// Dotts
	navigation: {
		nextEl: '.welcome__arrow--left',
		prevEl: '.welcome__arrow--right',
	},
	on: {
		lazyImageReady: function () {
			ibg();
...
new Swiper('.slider-project__slider', {
	wrapperClass: "slider-project__body",
	...
	loop: true,
	navigation: {
		nextEl: '.slider-project__arrow--left',
		prevEl: '.slider-project__arrow--right',
	},
	breakpoints: {
		320: {
			slidesPerView: 1.3,
